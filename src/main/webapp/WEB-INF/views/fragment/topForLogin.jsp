...
<div class="top_area">
	...
	<div>
		<a class="animateCart animated flash text-danger"
			href="<c:url value='' />"><i
			class="fas fa-shopping-cart animated flash" id="cartIcon"></i> </a>
	</div>
	<div style="display: flex; items-direction: row;">
		<span class="option" style="margin-right: 20px;"> <a
			href="<c:url value='/_04_order/shoppingCart.jsp' />"><i
				class="fas fa-shopping-cart" style="color: #0e2640;"></i></a>
		</span>
		<c:choose>
...
<ul id="a-style">
	<div class="test">
		...
		<li class="dropdown"><i class="fas fa-user-friends"></i> <a
			...
			<div class="dropdown-content">
				<a href="<c:url value='#' />">創建理念</a> <a href="<c:url value='#' />">團隊介紹</a>
