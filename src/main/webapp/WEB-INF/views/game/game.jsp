...
<!-- 		game -->
	...
	<div id="finish" style="display: none;">
		...
		<div class="d-flex justify-content-center align-items-center mb-3 mr-2 totalTime"  style="display: none;">花費時間:<time id="time"></time>秒</div>
	...
	<script type="text/javascript">
 		function showGameModel() { 
 			$("#gameModal").model("show"); 
			changeValue(); 
 		} 
 		function changeValue() { 
			$("#rangeValue") 
					.text($("#rangeNew").val() + ' X ' + $("#rangeNew").val()); 
 		}
	</script> 
	<script type="text/javascript">
 		$(document)
 						...
 						function() {
							...
							setTimeout(function() {
									...
									var startTime=new Date();
									 count = setInterval(function(){  // count = ID值
