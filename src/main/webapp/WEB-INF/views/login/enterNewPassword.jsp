								...
								<div class="col-lg-6">
									<div class="p-5">
										<div class="text-center">
											...
											<p class="h6 mb-4">請重新設定您的密碼</p>
										</div>
										<form class="user"
											action="<spring:url value='/member/changepswd'  />"
											method="POST">
											...
											<div class="checkPswd input-group">
											...
											<div id="passwordError" style="display: none;"
												class="errorText mt-3">密碼不相符</div>
											<button type="submit" id="checkbtn"
												class="btn btn-primary btn-user btn-block mt-4" disabled
												style="font-size: 16px">確認</button>
										</form>
										<hr>
