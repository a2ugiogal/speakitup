...
<body>
	<nav class="navbar navbar-expand-lg navbar-light fixed-top p-0"
		...
		<div class="mr-auto">
			...
			<a class="navbar-brand ml-3" href="#"> <img
				src="<spring:url value='/image/product/logo_trans_92px.png' /> "
				height="50px" /> 要抒拉
			</a>
		</div>
		<div class="navbar-nav flex-row ml-auto"
			style="position: absolute; right: 0; top: 10px;">
			<form class="form-inline mr-5" action="<spring:url value='/product/showPageProducts' /> " >
			...
			<a class="navbar-brand mr-5" href="#">登入</a> <a
				class="navbar-brand mr-5" href="#">註冊</a>
		</div>
			...
			<ul class="navbar-nav mr-auto">
				<li class="nav-item dropdown mx-2"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="#">天使板</a> <a class="dropdown-item"
							href="#">惡魔板</a>
					</div></li>
				<li class="nav-item dropdown mx-2"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="#">首頁</a> <a class="dropdown-item"
							href="#">購物車</a> <a class="dropdown-item" href="#">歷史訂單</a>
					</div></li>
				<li class="nav-item mx-2"><a class="nav-link" href="#">漂流瓶</a>
				</li>
			...
			<div id="carousel-card1" class="carousel slide" data-interval="5000">
				<div class="carousel-inner">
					<div class="carousel-item px-10 active">
						<div class="row">
								<c:forEach var="entry" items="${angel_products_map}" varStatus="number">
		...
		<div class="two_title my-5 text-center fluid">
			...
			<div id="carousel-card2" class="carousel slide" data-interval="5000">
				<div class="carousel-inner">
					<div class="carousel-item px-10 active">
						<div class="row">
							<c:forEach var="entry" items="${evil_products_map}" varStatus="number">
								<c:if test="${number.count % 2 == 1}">
								<a
									href="<spring:url value='/product/showProductInfo/${entry.value.productId}'/>"
									class="col-12 col-sm-6 col-lg-4 mt-4">
	...
	<div class="three_title mt-5 pt-5">
		<div class="black">
			<div class="yallow">
				...
				<span><a href="<spring:url value='/product/showPageProducts?categoryTitle=天使' /> " class="">來天使區找找吧</a></span>
			</div>
		</div>
		<div class="pink">
			<div class="white">
				<span>想跟家人、朋友、同學開點小小的玩笑嗎?你所想的到的惡搞小物都在這裡。 </span> <span><a
					href="<spring:url value='/product/showPageProducts?categoryTitle=惡魔' /> " id="goToDevilA">來惡魔區看看吧</a></span>
			</div>
		</div>
	</div>
	<!-- 第三區塊下的文字  -->
		...
		<div class="four_title">
			...
			<div class="four_top">
				...
				<div>
					...
					<img src="<spring:url value='/product/getProductImage/${entry}' />"
						class="four_img"></a>
				</div>
				</c:forEach>
			</div>
			...
			<div style="width: 100%; text-align: center;">
				<span class="four_bottom"> <a href="<spring:url value='/product/showPageProducts'/> ">More</a>
				</span>
			</div>
		</div>
	</div>
