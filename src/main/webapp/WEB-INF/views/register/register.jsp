...
<body>
	...
	<div class="container">
		...
		<div class="card o-hidden border-0 shadow-lg"
			style="margin: 108px 0px 48px 0px">
							...
							<form:form class="user" method='POST' modelAttribute="memberBean"
								...
								<div id="boxFileSelect" class="d-flex justify-content-center">
									...
									<p class="file">
										...
										<label for="file" class="rounded" style="font-size: 16px">上傳你的個人照片</label>
									</p>
								</div>
								<!-- 性別 -->
								<div class="d-flex justify-content-center gender mb-3">
									<input type="radio" class="magic-radio" id="male" name="gender"
										value="男" required="required"
										<c:if test='${mb.gender=="男"}'>checked='checked'</c:if>>
									<label for="male" class="mr-2">男</label> <input type="radio"
										class="magic-radio" id="female" name="gender" value="女"
										required="required" width="16px" height="16px"
								...
								<div class="form-group row">
									...
									<div class="col-sm-1 mb-3">
										<input type="button" id="btUserName" value="重複檢查"
											...
											style="background-color: rgb(196, 190, 190);" />
									</div>
									<!--帳號 error msg -->
