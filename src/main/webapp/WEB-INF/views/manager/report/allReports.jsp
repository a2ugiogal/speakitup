...
<link rel="stylesheet"
	href="<spring:url value='/css/manager/allreports.css' />" />
<link rel="stylesheet"
		...
		<div class="w-75 my-5 mx-auto Whistleblowing">
			...
			<ul class="nav nav-pills my-4" id="pills-tab" role="tablist">
				<li class="nav-item col text-sm-center"
					...
					href="<c:url value='/article/showReports?cmd=article'/>" role="tab"
					aria-controls="pills-home" aria-selected="true">文章</a>
				</li>
				<li class="nav-item col text-sm-center"
					style="padding-left: 0px !important; padding-right: 0px !important;">
					<a
					...
					href="<c:url value='/article/showReports?cmd=comment'/>" role="tab"
					aria-controls="pills-profile" aria-selected="false">留言</a>
				</li>
			</ul>
			...
			<form action="<spring:url value='/article/showReports'/>">
				...
				<div class="input-group my-3">
					...
					<input type="search" class="form-control"
						placeholder="${cmdSearch}" name="searchStr"
			...
			<div class="container-fluid"
				style="border: 1px solid rgba(82, 24, 24, 0.575); border-radius: 0.5em; background: rgba(255, 255, 255, 0.438);">
				<div class="row"
					style="border-bottom: 1px solid rgba(82, 24, 24, 0.575);">
					<div
				...
				<c:forEach var="entry" items="${cmdName}">
					...
					<a href="<c:url value='/article/showReportInfo/${cmdId}/${cmd}'/>"
						style="text-decoration: none; color: black;">
						<div class="row" id="allreports_list">
							<div
								class="col-2 d-flex justify-content-center align-items-center my-2">
								${cmdId}</div>
							<div
								class="col-3 d-flex justify-content-center align-items-center my-2">
								${entry.key.authorName}</div>
							<div
								class="col-2 d-flex justify-content-center align-items-center my-2">
